...
import { fmtCost, fmtMs, fmtNum as fmt } from '../format'
...
export function SummaryCards({ data, loading, currency }: Props) {
  if (loading || !data) {
    return (
      <div className="cards">
  ...
  const cards = [
    ...
    { label: 'Est. Cost',        value: fmtCost(data.cost, currency), sub: 'from pricing table' },
